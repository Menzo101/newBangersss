...
const SelectCuratorType = () => {
  ...
  const handleContinue = () => {
    ...
    setSignupData((prev) => ({ ...prev, curatorType: selectedCurator }));
    navigate("/signupform");
  };
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-5 py-2 shadow-sm">
              ...
              <span className="font-['Outfit'] text-gray-600 text-sm">
          ...
          {/* Heading */}
          <div className="mb-10">
            <h1 className="font-['Sora'] text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
              Select Curator Type
            </h1>
            <p className="font-['Outfit'] text-gray-500 text-base">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
            <SelectionCard
              ...
              selected={selectedCurator === "content_creator"}
              onClick={() => setSelectedCurator("content_creator")}
            />
            ...
            <SelectionCard
              ...
              description="Share your music , connect with curators and reach a wider audience."
              icon="music_blog"
              selected={selectedCurator === "music_blog"}
              onClick={() => setSelectedCurator("music_blog")}
            />

            <SelectionCard
              title="Playlist Curator"
              description="Share your music , connect with curators and reach a wider audience."
              icon="playlist_curator"
              selected={selectedCurator === "playlist_curator"}
              onClick={() => setSelectedCurator("playlist_curator")}
            />
          </div>
          ...
          <div className="flex items-center justify-center gap-4">
            <button
              onClick={() => navigate(-1)}
              className="px-8 py-3 rounded-xl font-['Sora'] font-semibold text-sm border-2 border-gray-300 text-gray-700 bg-white hover:bg-gray-50 transition-all duration-300"
            >
              Go Back
            </button>
            <button
              className={`px-8 py-3 rounded-xl font-['Sora'] font-semibold text-sm transition-all duration-300 ${
                selectedCurator
...
export default SelectCuratorType;
